<?php
// Heading
$_['heading_title']      = 'Veritrans Mandiri installment';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Veritrans account details!';
$_['text_veritransmandiri']     = '<a href="https://veritrans.co.id" target="_blank"><img src="view/image/payment/veritrans.png" width="120px" alt="Veritrans" title="Veritrans" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_live']          = 'Production';
$_['text_successful']    = 'Always Successful';
$_['text_fail']          = 'Always Fail';
$_['text_edit']          = 'Configure Veritrans Payment Gateway';
...
$_['entry_installment_mandiri_term'] = 'Installment term';
